    ...
    if match:
        ...
        if clave in repositorio_excels:
            for excel in repositorio_excels[clave]:
                ...
                nombre_excel = os.path.basename(excel).upper()

                # 🚫 Regla especial para Eldrin
                if responsable == "ELDRIN JOSE OROZCO" and "EVALUACION DE OBLIGACIONES CONTRACTUALES" in nombre_excel:
                    print("   🚫 Obligaciones contractuales omitidas para Eldrin")
                    continue
